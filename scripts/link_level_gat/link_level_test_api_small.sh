...
# embedding method and dimension: api_small, dimension: 1536
EMB_METHOD="api_small"
EMB_DIM=1536

# Set the model path
# train on BIRD training set for 500 epochs
MODEL_PATH_0="checkpoints/link_level_model/api_small/link_level_model_bird_20241129_135636.pt"

# train on combined training set for 500 epochs
MODEL_PATH_1="checkpoints/link_level_model/api_small/link_level_model_combined_20241129_133724.pt"
